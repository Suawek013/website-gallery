					...
					<ul>
						...
						<li>
							<DropdownButton
								...
								title="Practice"
							>
								<Dropdown.Item onClick={() => switchPage("practice/1week", 1)}>
									1 Week
								</Dropdown.Item>
								<Dropdown.Item onClick={() => switchPage("practice/2week", 2)}>
									2 Week
								</Dropdown.Item>
							</DropdownButton>
						</li>
						<li>
							<DropdownButton
								...
								title="Culture"
							>
								<Dropdown.Item onClick={() => switchPage("culture/leipzig", 3)}>
									Leipzig
								</Dropdown.Item>
								<Dropdown.Item onClick={() => switchPage("culture/berlin", 4)}>
									Berlin
								</Dropdown.Item>
							</DropdownButton>
						</li>
						<li>
							<Button
								onClick={() => switchPage("free_time", 5)}
								className="button-shadow"
								size="lg"
								variant="primary"
							>
